  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: IndexedStack(index: _tab, children: const [
        _StatsTab(), _RestaurantsTab(), _OrdersTab(), _DriversTab(), _ComplaintsTab(),
      ]),
    ...
    return StreamBuilder<List<Restaurant>>(stream: service.streamRestaurants(), builder: (ctx, snap) {
      ...
      return ListView.builder(padding: const EdgeInsets.all(12), itemCount: list.length, itemBuilder: (_, i) {
        ...
        return Card(child: ListTile(
          ...
          title: Text(r.name), subtitle: Text(r.description),
          trailing: Switch(value: r.isOpen, onChanged: (v) => service.toggleRestaurant(r.id, v)),
        ));
      });
    });
  }
